...
.SYNOPSIS
    ...
    Windows x64, listo para que Inno Setup lo empaquete.

.DESCRIPTION
    Se ejecuta EN WINDOWS (o con el SDK de .NET instalado apuntando a win-x64).
...
Write-Host "Publicando $project (win-x64, self-contained, un solo archivo)..." -ForegroundColor Cyan
