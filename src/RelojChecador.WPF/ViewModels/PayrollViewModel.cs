...
public sealed partial class PayrollViewModel : ObservableObject
{
    ...
    public string BuildCsv()
    {
        var header = new[]
        {
            "Empleado", "Sucursal", "Checadas de la semana", "Faltas", "Horas normales", "Horas extra",
            "Sueldo semanal", "Pago horas extra", "Total a pagar", "ISR", "IMSS", "Otro (monto)", "Otro (concepto)",
