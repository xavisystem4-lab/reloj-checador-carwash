...
/// <summary>
/// Edita PunchType y Notes de UNA marcación ya existente, o la borra por completo — pedido
/// explícito del usuario: "que las asistencias se puedan editar ... y pueda colocarle si es
/// entrada o salida ... nota en especial también. o eliminar Marcación". El guardado/borrado
/// real vive en AttendanceViewModel.EditAttendanceAsync/DeleteAttendanceAsync, no aquí — este
/// diálogo solo captura la intención del usuario.
///
...
public partial class EditAttendanceDialog : Window
{
    ...
    public EditAttendanceDialog(AttendanceRow row)
    {
        ...
        TimestampTextBlock.Text = row.Attendance.TimestampUtc.ToString("dd/MM/yyyy HH:mm:ss");
    ...
    private void OnDeleteClick(object sender, RoutedEventArgs e)
    {
        var confirmed = MessageBox.Show(
            this,
            $"¿Borrar PERMANENTEMENTE esta marcación ({EmployeeTextBlock.Text}, {TimestampTextBlock.Text})?\n\n" +
